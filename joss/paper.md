...
We also mask bad pixels that have been flagged by `calwf3` with data quality DQ = 4 or 512\footnote{for a list of DQ flags see the [the documentation of `calwf3`](https://wfc3tools.readthedocs.io/en/latest/wfc3tools/calwf3.html%23data-quality-initialization-dqicorr)}.
