...
scans, _r_<sub>1</sub> and r$_2$ are parameters to account for the exponential ramps.  _t_<sub>v</sub> and _t_ <sub>orb</sub> are the times from the first exposure in the visit and in the orbit, respectively.
